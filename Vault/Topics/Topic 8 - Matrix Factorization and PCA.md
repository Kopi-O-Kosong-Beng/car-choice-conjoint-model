...
- **SVD**: $X = U\Sigma V'$; truncating to top-k singular values = best rank-k approximation → image compression demo; also the engine behind latent-factor recommenders (ties to [[Vault/Topics/Topic 7 - Clustering and RecSys]]).
