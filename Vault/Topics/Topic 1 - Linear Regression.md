---
title: Topic 1 — Linear Regression
type: topic
tags: [course, topic-1]
updated: 2026-07-26
---
...
- Watch-outs: multicollinearity (VIF), out-of-sample validation (train/test split), extrapolation beyond data support — the same extrapolation issue behind our [[Data Dictionary|test-set income shift]].
