...
- Bias–variance tradeoff; train vs test error; **cross-validation** as the honest estimator (our whole pipeline rests on this — grouped by respondent, see [[Vault/Competition/Modeling Strategy & Results]]).
