...
>
> 1. **Section (i) describes the wrong model.** The graded submission will be whichever file
>    is best-public at close (currently `sub_20260729_nnblend.csv`, 1.194, second track;
>    possibly `sub_20260730_final00.csv`). Rewrite (i) around the final selected file after
